        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            <form action="{{ url('portal/submit_question') }}" method="post">
                                {{ csrf_field() }}
                      ...
                      ?>
                                        ...
                                        <ul class="question_option">
                                            <li><input type="radio" value="{{ $options['option1'] }}"
                                                    name="ans{{ $key+1 }}"> {{ $options['option1'] }}</li>
                                            <li><input type="radio" value="{{ $options['option2'] }}"
                                                    name="ans{{ $key+1 }}"> {{ $options['option2'] }}</li>
                                            <li><input type="radio" value="{{ $options['option3'] }}"
                                                    name="ans{{ $key+1 }}"> {{ $options['option3'] }}</li>
